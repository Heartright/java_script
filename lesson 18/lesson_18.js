...
<script> 
	...
	<body>
		...
		<button style="width: 200px;" onclick="textClick()">Нажмите на меня!</button>
	</body>
...
<script> 
			function textClick(){
				var elem = document.getElementById('text');
				elem.innerHTML = '<h3>' + text.innerHTML + '</h3>';
			}
</script>
	<body>
		<p id="text">При нажатии на кнопку абзац станет h3, но текст останется.</p>
		<button style="width: 200px;" onclick="textClick()">Нажмите на меня!</button>
	</body>
